...
avl::avl(char *_name, QTextEdit *log)
{
    ...
    log->append("- avl.h: "+temp+" ha sido abierto\n");
    ...
    QString avlistname=temp.mid(0,n);
...
void avl::create(int cuantos)
{
    disco.open(name,ios::binary | ios::in | ios::out);
        ...
        log->append("- avl.h: "+QString(name)+" se ha creado con "+QString::number(cuantos)+" bloques\n");
