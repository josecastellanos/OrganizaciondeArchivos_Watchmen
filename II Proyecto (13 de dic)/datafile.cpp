...
void dataFile::iniciar()
{
    inicio = clock();
}

void dataFile::detener()
{
    final = clock();
}

double dataFile::getMS()
{
    return ((clock() - inicio)*1000)/CLOCKS_PER_SEC ;
}

double dataFile::timeLlavesPrimarias()
{
    return this->timeAddLlavesPrimarias;
}

double dataFile::timeLlavesSecundarias()
{
    return this->timeAddLlavesSecundarias;
}

double dataFile::timeSearchHD()
{
    return this->timeSearchHashDestino;
}

double dataFile::timeSearchHS()
{
    return this->timeSearchHashSource;
}

double dataFile::timeSearchAV()
{
    return this->timeSearchAvl;
}

void dataFile::resetTime()
{
